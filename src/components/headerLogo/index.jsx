...
export default function HeaderLogo({ textColor, arrowColor, boxColor }) {
  return (
    <svg
    ...
    >
      <g data-padding="20">
        <g transform="translate(10 .894)scale(.96422)">
          ...
          <path
            fill={`${arrowColor}`}
            d="m787.236-.056 28.8 25.074-28.8 25.074h-19.045l21.93-19.062h-43.085V18.874h42.925L768.157-.092Zm40.23 18.621a6.655 6.655 0 1 0 0 13.31 6.655 6.655 0 1 0 0-13.31"
          />
        </g>
